...
object Dependencies {
  ...
  lazy val kafkaClientsDeps: List[ModuleID] = "org.apache.kafka" % "kafka-clients" % "2.6.0" :: Nil

  lazy val kafkaStreamsDeps: List[ModuleID] = "org.apache.kafka" %% "kafka-streams-scala" % "2.6.0" ::
                                              "org.apache.kafka" % "kafka-streams-test-utils" % "2.6.0" % Test :: Nil
